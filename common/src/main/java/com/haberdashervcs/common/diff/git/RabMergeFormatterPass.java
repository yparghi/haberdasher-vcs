// Based on JGit MergeFormatterPass, with RawText -> RabTextSequence
...
final class RabMergeFormatterPass {

    private final OutputStream out;

    private final MergeResult<RabTextSequence> res;
     ...
     */
    RabMergeFormatterPass(OutputStream out, MergeResult<RabTextSequence> res,
    ...
    void formatMerge() throws IOException {
        ...
        for (MergeChunk chunk : res) {
            RabTextSequence seq = res.getSequences().get(chunk.getSequenceIndex());
    ...
    private void writeLine(RabTextSequence seq, int i) throws IOException {
        String line = seq.getLine(i);
