...
/**
 * Supports {@link org.eclipse.jgit.internal.storage.pack.DeltaIndex} by performing a partial scan of the content.
 */
class DeltaIndexScanner {
    ...
    DeltaIndexScanner(RandomAccessBytes raw, int len) {
    ...
    private void scan(RandomAccessBytes raw, int end) {
